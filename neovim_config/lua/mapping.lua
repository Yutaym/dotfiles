...
vim.keymap.set({'v'}, 'gh', '^', {noremap = true, silent = true})
...
if (vim.g.vscode) then
    ...
    vim.keymap.set('n', 'ss', '/', {noremap = true})
    vim.keymap.set('n', 'sr', ':s/', {noremap = true})
    ...
    vim.keymap.set('n', 'sh', function() vim.cmd('call VSCodeNotify("workbench.action.navigateLeft")') end, {noremap = true, silent = true})
    vim.keymap.set('n', 'sj', function() vim.cmd('call VSCodeNotify("workbench.action.navigateDown")') end, {noremap = true, silent = true})
    vim.keymap.set('n', 'sk', function() vim.cmd('call VSCodeNotify("workbench.action.navigateUp")') end, {noremap = true, silent = true})
    vim.keymap.set('n', 'sl', function() vim.cmd('call VSCodeNotify("workbench.action.navigateRight")') end, {noremap = true, silent = true})
    ...
    vim.keymap.set('n', 'so', function() vim.cmd('call VSCodeNotify("workbench.action.toggleMaximizeEditorGroup")') end, {noremap = true, silent = true})
